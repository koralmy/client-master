  ...
  return (
    ...
    >
      <DialogTitle id="alert-dialog-title">
        {"Are you sure you want ot delete this card"}
      </DialogTitle>
      <DialogContent>
        <DialogContentText id="alert-dialog-description">
          this operation will delete the card permanently, this card will not be
          recoverable. all the data will be lost. are you sure you want to
          delete this card?
        </DialogContentText>
      </DialogContent>
      <DialogActions>
